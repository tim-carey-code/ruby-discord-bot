...
bot = Discordrb::Bot.new token: ENV['DISCORD_TOKEN'], intents: %i[servers server_messages server_webhooks]
...
RegisterCommands.register_all(bot) if ENV['REGISTER_COMMANDS'] == 'true'
